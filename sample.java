...
public class sample {
    ...
    public static void main(String[] args)throws JSONException, IOException {
        ...
        String accessToken="lX1GkfB5yY5fYi4LgPRSHQXTkhWF2a7lxPV3mTNv1EiUlN0XN4u9JkqVySxhSdNrCMXIhIf_8yRZy0RErr68MI1FnHn_1WbZXd2eZmUI9zeGY_jSu0XdEkclzL_uWHYx";

        OkHttpClient client = new OkHttpClient();
        MediaType mediaType = MediaType.parse("application/x-www-form-urlencoded");
        RequestBody body = RequestBody.create(mediaType, "client_id=uX4P1ceVg4_kfsi-miohDA&client_secret=4fOdvNkltK7LWrf4poQkEhBgUVGDJKk86oziaMIjgiiFsIyVmQlVaART0jhFtMDO&grant_type=client_credentials");
        ...
        String location = "San Jose, CA";            // location
